...
const HrSection: React.FC = () => {
  const details: { title: string; icon: string; desc: string }[] = [
    {
      title: 'Phone',
      icon: 'phone-call',
      desc: '+91 75730 15366  /  72279 77744',
    },
    {
      title: 'Mail',
      icon: 'envelope',
      desc: 'career@acutaas.com',
    },
  ];
      ...
      <div className="main-container">
        <div className="flex flex-col gap-8 md:gap-10 lg:gap-14">
          ...
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="order-1 flex flex-col gap-12 md:gap-14 lg:order-2">
                ...
                <div className="flex flex-col items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#453A3D]">
                      ...
                      {' / '}
                      <a href="tel:7227977744">72279 77744</a>
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-start gap-4">
